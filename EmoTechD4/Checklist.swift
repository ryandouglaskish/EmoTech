...
//        }
   ...
   // }
        if show {
            ZStack {
                Rectangle().fill(Color.black).cornerRadius(20).frame(width: 302, height: 402)
                Rectangle().fill(Color.white).cornerRadius(20).frame(width: 300, height: 400)
                VStack {
                Text("Welcome to your daily checklist! You can set yourself daily goals, objectives, or anything you need to get done. It can be anything from doing your homework to being more grateful for your family, to filing your taxes. Just get it done!").font(Font.custom(book, size: 18)).multilineTextAlignment(.leading)
